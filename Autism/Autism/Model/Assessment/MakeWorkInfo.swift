...
struct MakeWordInfo: Codable {
    ...
    init(from decoder: Decoder) throws {
       ...
       self.completion_time         = try container.decodeIfPresent(Int.self, forKey: .completion_time) ?? 0
        ...
        self.option                 = try container.decodeIfPresent([OptionModel].self, forKey: .option) ?? []
        self.word                   = try container.decodeIfPresent([OptionModel].self, forKey: .word) ?? []
