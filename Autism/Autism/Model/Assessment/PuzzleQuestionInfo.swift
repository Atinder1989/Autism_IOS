...
struct PuzzleQuestionInfo: Codable {
    var id: String
    var question_type: String
    var question_title: String
    var language_code: String
    var frame_image: String
    var trial_time: Int
    ...
    init(from decoder: Decoder) throws {
        ...
        self.question_type          = try container.decodeIfPresent(String.self, forKey: .question_type) ?? ""
         ...
         self.frame_image          = try container.decodeIfPresent(String.self, forKey: .frame_image) ?? ""
        ...
        self.block    = try container.decodeIfPresent([PuzzleBlock].self, forKey: .block) ?? []
