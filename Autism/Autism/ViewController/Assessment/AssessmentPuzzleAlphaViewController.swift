//
//  AssessmentPuzzleAlphaViewController.swift
//  Autism
//
//  Created by Savleen on 09/10/20.
...
class AssessmentPuzzleAlphaViewController: UIViewController, UIDragInteractionDelegate {
    
    private let puzzleViewModel = AssessmentPuzzleAlphaViewModel()
...
extension AssessmentPuzzleAlphaViewController: SpeechManagerDelegate {
...
extension AssessmentPuzzleAlphaViewController: ImageDownloaderDelegate {
...
extension AssessmentPuzzleAlphaViewController: NetworkRetryViewDelegate {
    func didTapOnRetry() {
...
extension AssessmentPuzzleAlphaViewController: AutismTimerDelegate {
    func timerUpdate() {
