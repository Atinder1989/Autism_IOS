//
//  TrialGrabingViewModel.swift
//  Autism
//
//  Created by Dilip Technology on 29/06/21.
//  Copyright © 2021 IMPUTE. All rights reserved.
//

import Foundation

class TrialGrabingViewModel: NSObject {
    ...
    private var mazeInfo: MazesInfo? {
        didSet {
            self.executeCommand()
        }
    }
...
extension TrialGrabingViewModel {
    private func executeCommand() {
        if let commandResponseVO = self.mazeInfo  {
...
extension TrialGrabingViewModel: SpeechManagerDelegate {
...
extension TrialGrabingViewModel: ScriptManagerDelegate {
