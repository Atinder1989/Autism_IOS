//
//  TrialBalloonGameViewModel.swift
//  Autism
//
...
class TrialBalloonGameViewModel: NSObject {
...
extension TrialBalloonGameViewModel {
    private func executeCommand() {
        if let commandResponseVO = self.balloonGameQuestionInfo  {
...
extension TrialBalloonGameViewModel: SpeechManagerDelegate {
...
extension TrialBalloonGameViewModel: ScriptManagerDelegate {
