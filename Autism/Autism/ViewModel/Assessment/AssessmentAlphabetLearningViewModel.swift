//
//  AssessmentAlphabetLearningViewModel.swift
//  Autism
//
...
class AssessmentAlphabetLearningViewModel: NSObject {
    ...
    func submitUserAnswer(successCount:Int,info:AlphabetLearningInfo,timeTaken:Int,skip:Bool,touchOnEmptyScreenCount:Int,selectedIndex:Int) {
        ...
        if let user = UserManager.shared.getUserInfo() {
            service.params = [ ServiceParsingKeys.user_id.rawValue:user.id,
                ...
                ServiceParsingKeys.selectedIndex.rawValue:selectedIndex,
