//
//  AssessmentBodyTrackingViewModel.swift
//  Autism
//
//  Created by Savleen on 16/09/20.
//  Copyright © 2020 IMPUTE. All rights reserved.
//

import Foundation

class AssessmentBodyTrackingViewModel:NSObject {
 var dataClosure : (() -> Void)?
    ...
    func submitFaceTrackDetails(info:BodyTrackingQuestionInfo,timetaken:Int,successRate:Int,touchOnEmptyScreenCount:Int,skip:Bool) {
        ...
        if let user = UserManager.shared.getUserInfo() {
            service.params = [
               ...
               ServiceParsingKeys.complete_rate.rawValue : successRate,
               ServiceParsingKeys.success_count.rawValue :successRate,
