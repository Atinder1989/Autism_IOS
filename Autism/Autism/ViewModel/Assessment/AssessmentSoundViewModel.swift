//
//  AssessmentSoundViewModel.swift
//  Autism
//
...
class AssessmentSoundViewModel:NSObject {
 var dataClosure : (() -> Void)?
    ...
    func submitSoundQuestionDetails(info:SoundImitationInfo,completeRate:Int,timetaken:Int) {
