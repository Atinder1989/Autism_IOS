//
//  AssessmentBalloonGameViewModel.swift
//  Autism
//
//  Created by Savleen on 22/05/21.
//  Copyright © 2021 IMPUTE. All rights reserved.
//

import Foundation

class AssessmentBalloonGameViewModel: NSObject {
    ...
    func submitUserAnswer(successCount:Int,info:BalloonGameQuestionInfo,timeTaken:Int,skip:Bool) {
