//
//  AssessmentVideoViewModel.swift
//  Autism
//
...
class AssessmentVideoViewModel:NSObject  {
    ...
    func submitUserAnswer(successCount:Int,info:VideoInfo,timeTaken:Int,skip:Bool,touchOnEmptyScreenCount:Int,selectedIndex:Int) {
