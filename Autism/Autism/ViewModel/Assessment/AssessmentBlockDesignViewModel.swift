//
//  AssessmentBlockDesignViewModel.swift
//  Autism
//
...
class AssessmentBlockDesignViewModel: NSObject {
    ...
    func submitUserAnswer(successCount:Int,info:BlockDesignInfo,timeTaken:Int,skip:Bool,touchOnEmptyScreenCount:Int,incorrectDragDropCount:Int) {
