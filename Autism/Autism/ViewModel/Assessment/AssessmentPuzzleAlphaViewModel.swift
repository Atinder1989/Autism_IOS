//
//  AssessmentPuzzleAlphaViewModel.swift
//  Autism
//
...
class AssessmentPuzzleAlphaViewModel:NSObject  {
    ...
    func submitUserAnswer(successCount:Int,puzzleCount:Int,info:PuzzleQuestionInfo,timeTaken:Int,skip:Bool,touchOnEmptyScreenCount:Int,incorrectDragDropCount:Int) {
        ...
        if let user = UserManager.shared.getUserInfo() {
            service.params = [ ServiceParsingKeys.user_id.rawValue:user.id,
                ...
                ServiceParsingKeys.puzzle_count.rawValue : puzzleCount,
