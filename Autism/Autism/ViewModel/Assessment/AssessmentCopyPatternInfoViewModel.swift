//
//  AssessmentCopyPatternInfoViewModel.swift
//  Autism
//
...
import Foundation
class AssessmentCopyPatternInfoViewModel: NSObject {
    ...
    func submitUserAnswer(successCount:Int,info:CopyPatternInfo,timeTaken:Int,skip:Bool,touchOnEmptyScreenCount:Int,incorrectDragDropCount:Int) {
