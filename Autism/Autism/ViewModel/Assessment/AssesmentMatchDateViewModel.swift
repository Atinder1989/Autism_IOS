//
//  AssesmentMatchDateViewModel.swift
//  Autism
//
...
class AssesmentMatchDateViewModel:NSObject  {
    ...
    func submitUserAnswer(successCount:Int,info:MatchDate,timeTaken:Int,skip:Bool) {
