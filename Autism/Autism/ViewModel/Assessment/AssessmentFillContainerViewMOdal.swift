//
//  AssessmentFillContainerViewMOdal.swift
//  Autism
//
...
class AssessmentFillContainerViewModal:NSObject  {
    ...
    func submitUserAnswer(successCount:Int,info:FillContainerQuestionInfo,timeTaken:Int,skip:Bool,touchOnEmptyScreenCount:Int,incorrectDragDropCount:Int) {
