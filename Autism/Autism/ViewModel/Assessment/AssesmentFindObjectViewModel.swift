//
//  AssesmentFindObjectViewModel.swift
//  Autism
//
...
class AssesmentFindObjectViewModel:NSObject  {
    ...
    func submitUserAnswer(successCount:Int,info:FindObject,timeTaken:Int,skip:Bool,touchOnEmptyScreenCount:Int,wrongAnswerCount:Int) {
            ...
            if let user = UserManager.shared.getUserInfo() {
                service.params = [ ServiceParsingKeys.user_id.rawValue:user.id,
                    ...
                    ServiceParsingKeys.wrongAnswerCount.rawValue:wrongAnswerCount,
