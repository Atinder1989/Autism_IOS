//
//  AssesmentMazeObjectViewModel.swift
//  Autism
//
...
class AssesmentMazeObjectViewModel:NSObject  {
    ...
    func submitUserAnswer(successCount:Int,info:MazeObject,timeTaken:Int,skip:Bool,touchOnEmptyScreenCount:Int,selectedIndex:Int) {
