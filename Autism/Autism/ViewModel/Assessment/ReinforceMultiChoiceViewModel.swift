//
//  ReinforceMultiChoiceViewModel.swift
//  Autism
//
...
class ReinforceMultiChoiceViewModel: NSObject {
    ...
    func submitQuestionDetails(info:ReinforceMultiChoiceInfo,completeRate:Int,timetaken:Int,skip:Bool,touchOnEmptyScreenCount:Int,selectedIndex:Int) {
