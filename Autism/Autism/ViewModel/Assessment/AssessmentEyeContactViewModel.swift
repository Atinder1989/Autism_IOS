//
//  AssessmentEyeContactViewModel.swift
//  Autism
//
...
class AssessmentEyeContactViewModel:NSObject {
 var dataClosure : (() -> Void)?
    ...
    func submitEyecontactDetails(info:EyeContactQuestionInfo,timetaken:Int,skip:Bool,touchOnEmptyScreenCount:Int) {
