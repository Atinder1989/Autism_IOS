//
//  AssessmentmakeWordInfoViewModel.swift
//  Autism
//
...
class AssessmentMakeWordInfoViewModel: NSObject {
    ...
    func submitUserAnswer(successCount:Int,info:MakeWordInfo,timeTaken:Int,skip:Bool,touchOnEmptyScreenCount:Int) {
