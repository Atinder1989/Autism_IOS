//
//  AssessmentEnvironmentalSoundViewModel.swift
//  Autism
//
...
class AssessmentEnvironmentalSoundViewModel:NSObject {
 var dataClosure : (() -> Void)?
    ...
    func submitIntroductionQuestionDetails(info:EnvironmentalSoundQuestionInfo,completeRate:Int,timetaken:Int,skip:Bool,touchOnEmptyScreenCount:Int) {
