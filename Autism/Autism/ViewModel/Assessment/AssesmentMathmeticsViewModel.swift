//
//  AssesmentMathmeticsViewModel.swift
//  Autism
//
...
class AssesmentMathmeticsViewModel:NSObject  {
    ...
    func submitUserAnswer(successCount:Int,info:MathematicsCalculation,timeTaken:Int,skip:Bool) {
